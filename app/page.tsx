...
const StarIcon = () => (
  <svg className="w-6 h-6 fill-current text-yellow-400" viewBox="0 0 24 24" aria-hidden="true">
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#F5F3FF] font-['Plus_Jakarta_Sans',sans-serif]">
      {/* Hero Section */}
      <section className="py-20 px-5 text-center">
        <h1 className="text-[clamp(2rem,6vw,3.5rem)] font-bold text-[#1E1B4B] mb-6 leading-tight">
          Web Hosting That Just Works
        </h1>
        <p className="text-[clamp(1rem,2vw,1.25rem)] text-[#1E1B4B] max-w-2xl mx-auto mb-10 leading-relaxed opacity-90">
          Fast, secure, and reliable hosting that makes your website perform at its best
        </p>

        <button
          className="bg-[#10B981] text-white text-lg font-semibold px-10 py-4 rounded-lg border-none cursor-pointer transition-all duration-200 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2"
        >
          Start Free Trial
        </button>

        {/* Video Player */}
        <div className="mt-16 max-w-5xl mx-auto rounded-2xl overflow-hidden">
          <Player
      ...
      <section className="py-20 px-5 max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl p-10 mb-10 cursor-pointer transition-all duration-200 hover:shadow-lg">
          <h2 className="text-[clamp(1.5rem,4vw,2.25rem)] font-bold text-[#1E1B4B] mb-5">
            The Problem: Slow & Unreliable Hosting
          </h2>
          <p className="text-lg text-[#1E1B4B] leading-relaxed opacity-80">
        ...
        <div className="bg-[#6366F1] text-white rounded-2xl p-10 mb-10">
        ...
        <div className="bg-white rounded-2xl p-10 mb-10">
          ...
          <p className="text-lg text-[#1E1B4B] leading-relaxed mb-8 opacity-80">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-[#F5F3FF] rounded-xl p-6 cursor-pointer transition-all duration-200 hover:opacity-90 border-2 border-transparent hover:border-[#6366F1]"
              >
                <div className="text-[#6366F1] mb-4 flex justify-center">
                  <feature.icon />
                </div>
                <h3 className="text-xl font-bold text-[#1E1B4B] mb-3">
                  {feature.title}
                </h3>
                <p className="text-base text-[#1E1B4B] leading-relaxed opacity-80">
                  {feature.description}
                </p>
              </div>
            ))}
        ...
        <div className="bg-[#6366F1] text-white rounded-2xl p-10 mb-10">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-8">
            <div className="bg-white/10 rounded-xl p-6 cursor-pointer transition-all duration-200 hover:bg-white/20 border-2 border-transparent hover:border-white/50">
              <img
        ...
        <div className="bg-white rounded-2xl p-10">
          <h2 className="text-[clamp(1.5rem,4vw,2.25rem)] font-bold text-[#1E1B4B] mb-8 text-center">
            Image Gallery
          </h2>
      ...
      <section className="py-20 px-5 bg-[#6366F1] text-white">
        <h2 className="text-[clamp(1.5rem,4vw,2.25rem)] font-bold text-center mb-12">
          What Our Customers Say
        </h2>

        <div className="max-w-4xl mx-auto bg-white/10 rounded-2xl p-10">
          {/* Testimonial Card */}
            ...
            <div className="flex gap-3 mt-8">
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full border-none cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#6366F1] ${
      ...
      <section className="py-24 px-5 text-center">
        <h2 className="text-[clamp(1.75rem,5vw,3rem)] font-bold text-[#1E1B4B] mb-6">
        ...
        <button
          className="bg-[#10B981] text-white text-xl font-semibold px-16 py-5 rounded-lg border-none cursor-pointer transition-all duration-200 hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2"
        >
      ...
      <footer className="py-10 px-5 text-center bg-white">
        <p className="text-[#1E1B4B] text-sm opacity-60">
